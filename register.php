...
<main class="form-signin w-100 m-auto">
  <form class="card p-4" id="register-form">
    <h1 class="h3 mb-3 fw-normal">Registracija</h1>

    <div class="form-floating">
        <input class="form-control" id="first_name" placeholder="Ime">
        <label for="first_name">Ime</label>
        <div id="first_name_error" class="text-danger"></div>
    </div>
    <div class="form-floating">
        <input class="form-control" id="last_name" placeholder="Prezime">
        <label for="last_name">Prezime</label>
        <div id="last_name_error" class="text-danger"></div>
    </div>
    <div class="form-floating">
        <input class="form-control" id="phone" placeholder="Broj telefona">
        <label for="phone">Broj telefona</label>
        <div id="phone_error" class="text-danger"></div>
    </div>
    <div class="form-floating">
        <input class="form-control" id="email" placeholder="Email adresa">
    ...
    <div class="form-floating mb-4">
        <input type="password" class="form-control" id="password_confirmation" placeholder="Potvrdi lozinku">
